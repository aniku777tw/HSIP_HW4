...
#   if plot == True then plot figure
    ...
    plt.plot(range(len(time3)),time3 ,'b',label = 'Casaul')
    plt.plot(range(len(time5)),time5 ,'r',label ='Woodbury')
    plt.legend()
    plt.xlim(0,4096)
    
    plt.figure("computing time K")
    plt.title("computing time K")
    plt.plot(range(len(time4)),time4 ,'b',label = 'Casaul')
    plt.plot(range(len(time6)),time6 ,'r',label ='Woodbury')
    plt.legend()
    plt.xlim(0,4096)
